...
The expected hashes must come from artifacts your verifier trusts. The [quickstart](https://cmcp.agentrust-io.com/quickstart/#confirm-your-setup) computes them from local input files before startup. Gateway logs also print hashes, but those logs alone do not establish approval:
