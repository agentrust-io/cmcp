...
1. Verify signature using tee_public_key
1. Check policy_bundle.hash against the approved hash on record
1. Check tool_catalog.hash against the approved catalog hash on record
1. Walk audit_chain_root to audit_chain_tip for call-level detail
