...
This page explains the four core design ideas behind cMCP. The [quickstart](https://cmcp.agentrust-io.com/docs/quickstart/index.md) shows you how to run it; this page explains why it works.
...
See [Spec: Attestation](https://cmcp.agentrust-io.com/docs/spec/attestation/index.md) for the full verification protocol.
...
See [Spec: Call Graph](https://cmcp.agentrust-io.com/docs/spec/call-graph/index.md) for the full chain construction.
...
See [Spec: Cedar Policy](https://cmcp.agentrust-io.com/docs/spec/cedar-policy/index.md) for the full schema and supported context attributes.
...
- [Quickstart](https://cmcp.agentrust-io.com/docs/quickstart/index.md): run a cMCP gateway locally in under 30 minutes
- [Configuration](https://cmcp.agentrust-io.com/docs/configuration/index.md): full configuration reference
- [Tutorial: Cedar policy walkthrough](https://cmcp.agentrust-io.com/docs/tutorials/cedar-policy-walkthrough/index.md): write and test policies
- [Tutorial: Verify a TRACE claim](https://cmcp.agentrust-io.com/docs/tutorials/verifying-a-trace-claim/index.md): verify a claim without trusting the operator
- [Spec: Component Model](https://cmcp.agentrust-io.com/docs/spec/component-model/index.md): detailed architecture
