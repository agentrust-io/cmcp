...
def test_benchmark_runs_smoke(tmp_path, benchmark_gateway_seam):
    ...
    from cmcp_runtime.benchmarks import _run
...
def test_benchmark_percentile():
    from cmcp_runtime.benchmarks import _percentile
...
def test_benchmark_stats():
    from cmcp_runtime.benchmarks import _stats
...
def test_benchmark_catalog_is_usable():
    ...
    from cmcp_runtime.benchmarks import _make_catalog
